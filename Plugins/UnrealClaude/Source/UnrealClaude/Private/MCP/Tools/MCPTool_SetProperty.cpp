...
bool FMCPTool_SetProperty::SetStructPropertyValue(FStructProperty* StructProp, void* ValuePtr, const TSharedPtr<FJsonValue>& Value)
{
	...
	const bool bIsFColor = (StructProp->Struct == TBaseStructure<FColor>::Get()) || (StructName == FName("Color"));
	const bool bIsLinearColor = (StructProp->Struct == TBaseStructure<FLinearColor>::Get()) || (StructName == FName("LinearColor"));
	const bool bIsVector = (StructProp->Struct == TBaseStructure<FVector>::Get()) || (StructName == FName("Vector"));
	const bool bIsRotator = (StructProp->Struct == TBaseStructure<FRotator>::Get()) || (StructName == FName("Rotator"));
